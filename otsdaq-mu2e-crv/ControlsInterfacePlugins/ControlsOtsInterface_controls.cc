...
ControlsOtsInterface::ControlsOtsInterface (const std::string& interfaceUID, const ConfigurationTree& theXDAQContextConfigTree, const std::string& controlsConfigurationPath)
    //  :Socket            (
    ...
    // ,
    : ControlsVInterface (interfaceUID, theXDAQContextConfigTree, controlsConfigurationPath)
{
}
