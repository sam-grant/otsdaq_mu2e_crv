...
public:
  ...
  Header::counter_t hdr_bunch_counter() const {
    return header_()->bunch_counter;
  }
  Header::counter_t hdr_trigger_counter() const {
    return header_()->trigger_counter;
  }
  Header::counter_t hdr_trigger_input0() const {
    return header_()->trigger_input0;
  }
  Header::counter_t hdr_trigger_input1() const {
