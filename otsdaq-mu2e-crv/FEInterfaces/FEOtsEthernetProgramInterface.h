...
class FEOtsEthernetProgramInterface
    : public FEOtsUDPTemplateInterface // public FEVInterface, public
                                       // OtsUDPHardware, public
...
public:
  ...
  // override;  void stop             				(void) override;
  // bool running   		  				(void) override;

  void getListOfProgramFiles(frontEndMacroInArgs_t argsIn,
                             frontEndMacroOutArgs_t argsOut);
  void loadProgramFile(frontEndMacroInArgs_t argsIn,
                       frontEndMacroOutArgs_t argsOut);

  ///////////////////////
  // inherits these from Template interface
  //
  //	virtual int universalRead	  	(char* address, char* readValue)
  //override; 	virtual void universalWrite	  	(char* address, char*
  //writeValue) override;  private: 	void runSequenceOfCommands(const
  //std::string &treeLinkName);
};
