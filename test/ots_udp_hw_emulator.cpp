  ...
  while (1) {
    ...
    if (FD_ISSET(sockfd, &readfds)) {
      ...
      if ((totalNumberOfBytes =
               recvfrom(sockfd, buff, MAXBUFLEN - 1, 0,
      ...
      while (
          handlerIndex < totalNumberOfBytes &&
        ...
        {
          uint64_t addr;
          memcpy((void *)&addr, (void *)&buff[handlerIndex + RX_ADDR_OFFSET],
                 8);
          ...
          if ((numberOfBytes = sendto(sockfd, buff, packetSz, 0,
                   ...
                   buff[handlerIndex + 0] == 1) // write
        {
          ...
          case 0x1001:
            memcpy((void *)&data_gen_cnt,
                   (void *)&buff[handlerIndex + RX_DATA_OFFSET], 8);
            __COUT__ << std::hex << ":::"
          ...
          case 0x1003:
            memcpy((void *)&led_register,
                   (void *)&buff[handlerIndex + RX_DATA_OFFSET], 1);
            __COUT__ << std::hex << ":::"
          ...
          case 0x0000000100000006: {
            ...
            memcpy((void *)&ip, (void *)&buff[handlerIndex + RX_DATA_OFFSET],
                   4);
            ip = htonl(ip);
